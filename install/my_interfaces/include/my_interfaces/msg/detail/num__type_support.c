...
#include <stddef.h>
#include "my_interfaces/msg/detail/num__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  my_interfaces__msg__Num__init(message_memory);
}

void Num__rosidl_typesupport_introspection_c__Num_fini_function(void * message_memory)
{
  my_interfaces__msg__Num__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Num__rosidl_typesupport_introspection_c__Num_message_member_array[1] = {
  {
    ...
    offsetof(my_interfaces__msg__Num, num),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Num__rosidl_typesupport_introspection_c__Num_message_members = {
  ...
  "Num",  // message name
  1,  // number of fields
  sizeof(my_interfaces__msg__Num),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_interfaces, msg, Num)() {
