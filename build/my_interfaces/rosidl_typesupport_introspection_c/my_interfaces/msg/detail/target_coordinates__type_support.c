...
#include <stddef.h>
#include "my_interfaces/msg/detail/target_coordinates__rosidl_typesupport_introspection_c.h"
...
#include "my_interfaces/msg/detail/target_coordinates__struct.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  my_interfaces__msg__TargetCoordinates__init(message_memory);
}

void TargetCoordinates__rosidl_typesupport_introspection_c__TargetCoordinates_fini_function(void * message_memory)
{
  my_interfaces__msg__TargetCoordinates__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember TargetCoordinates__rosidl_typesupport_introspection_c__TargetCoordinates_message_member_array[1] = {
  {
    ...
    offsetof(my_interfaces__msg__TargetCoordinates, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers TargetCoordinates__rosidl_typesupport_introspection_c__TargetCoordinates_message_members = {
  ...
  1,  // number of fields
  sizeof(my_interfaces__msg__TargetCoordinates),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_interfaces, msg, TargetCoordinates)() {
